<?php
/**
 * WeekWise 2.3 - Installer
 * 
 * This installer sets up WeekWise on any standard webspace.
 * Requirements: PHP 5.6+ with allow_url_fopen enabled
 */
...
$sourceUrl = 'https://raw.githubusercontent.com/HndrkDrs/WeekWise/main/';
...
<head>
    ...
    <title>WeekWise 2.3 - Installation</title>
    <style>
        * {
...
<body>
    <div class="install-box">
        ...
        <div class="features">
            <h4>Neue Features:</h4>
            <ul>
                <li>ICS-Kalender-Export und Abo-URLs</li>
                <li>Event-Modus mit Drag & Drop</li>
                <li>Mehrfachauswahl und Duplizieren</li>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>WeekWise 2.3 - Fehler</title>
    <style>
        body {
            display: flex;
            justify-content: center;
